...
//     if (result.success) {
//         if (result.needsVerification) {
//             alert("Account created successfully! 📧 Check your email inbox to verify your account before logging in (check span also).");
//             onSwitchToLogin(); 
//         } else {
//             navigate('/dashboard', { replace: true });
//         }
...
//       <div className="bg-blue-50 px-6 pt-12 pb-8 rounded-b-[2.5rem] shadow-sm relative">

//       {/* 🌐 LANGUAGE SELECTOR BUTTON */}
//         <button 
//             onClick={() => setShowLanguage(true)}
//             className="absolute top-10 right-6 p-2.5 bg-white/60 backdrop-blur-md rounded-full text-blue-600 shadow-sm border border-white/50 active:scale-95 transition-transform"
//         >
//             <Globe size={22} />
//         </button>
