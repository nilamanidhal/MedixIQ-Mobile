...
const MobileLayout = () => {
  return (
    //  Make it a relative container so BottomNav floats on top, no flex-col cage
    <div className="relative h-[100dvh] w-full bg-slate-50 overflow-hidden">
      
      {/*  Let the child pages (Outlet) fill the screen and handle their own scrolling */}
      <div className="absolute inset-0 h-full w-full ">
        <Outlet />
      </div>

      {/* Global Overlays & Navigation */}
      <BottomNav />
